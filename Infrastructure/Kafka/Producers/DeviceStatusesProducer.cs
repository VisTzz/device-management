...
namespace DevicesManagement.Infrastructure.Kafka.Producers
{
    public class DeviceStatusesProducer<K, V>
    {
        IProducer<K, V> kafkaHandle;

        public DeviceStatusesProducer(KafkaClientHandle handle)
        {
